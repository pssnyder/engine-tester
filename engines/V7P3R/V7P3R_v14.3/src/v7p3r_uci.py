#!/usr/bin/env python3
"""
V7P3R v14.3 UCI Interface - Move Ordering Optimizations
Quick wins: Pawn advancement bonus, explicit promotion priority, limited tactical detection
Targeting search overhead reduction before major gives_check() refactor
"""
