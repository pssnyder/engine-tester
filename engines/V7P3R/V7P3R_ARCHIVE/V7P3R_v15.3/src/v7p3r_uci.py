#!/usr/bin/env python3
"""V7P3R v15.3 UCI Interface

Version 15.3: Added opening book support
            ...
            if command == "quit":
                ...
                if len(parts) >= 5 and parts[1] == "name" and parts[3] == "value":
                    ...
                    if option_name == "MaxDepth":
                        ...
                        if option_value and option_value != "<empty>":
                            success = engine.opening_book.load_polyglot_book(option_value)
                            if not success:
                                print(f"info string Failed to load book: {option_value}", flush=True)
