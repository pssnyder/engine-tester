...
- Static Exchange Evaluation (SEE) for move safety

v15.3 Changes from v15.2:
- Added: Opening book system with embedded repertoire
- Added: Polyglot .bin format support for external books
- Added: UCI options: OwnBook, BookFile, BookDepth, BookVariety
- Result: Strong opening play from known positions
