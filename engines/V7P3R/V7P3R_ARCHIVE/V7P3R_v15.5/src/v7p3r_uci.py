#!/usr/bin/env python3
"""V7P3R v15.5 UCI Interface

Version 15.5: Fixed v15.4's weak blended evaluation
- PST-first evaluation (strength of PositionalOpponent)
- Material safety net (prevents catastrophic losses)
- Bishop pair awareness in material calculation
- Opening book support (from v15.3)

v15.4 had 21.4% win rate due to diluted PST evaluation
v15.5 restores PST dominance with material sanity checks
"""
