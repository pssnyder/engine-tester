#!/usr/bin/env python3
"""
V7P3R v16.0 UCI Interface
Clean UCI implementation for V16.0
"""
...
class UCIEngine:
    ...
    def _handle_uci(self):
        ...
        print("id name V7P3R v16.0", flush=True)
    ...
    def _handle_setoption(self, args):
        ...
        try:
            if option_name == "MaxDepth":
                self.engine.max_depth = int(option_value)
            elif option_name == "TTSize":
                tt_size_mb = int(option_value)
                self.engine.tt_size = (tt_size_mb * 1024 * 1024) // 64
