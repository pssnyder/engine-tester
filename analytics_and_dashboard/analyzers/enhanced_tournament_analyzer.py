#!/usr/bin/env python3
"""
Enhanced Tournament Analyzer with Deep Game Analysis
...
class EnhancedTournamentAnalyzer:
    def __init__(self, results_dir: str = "../../results", dashboard_data_dir: str = "../dashboard/data"):
    ...
    def update_engine_statistics(self, game_data: Dict):
        ...
        for color, engine in engines_to_update:
            ...
            if result == "1-0":
                if color == 'white':
                    stats['wins'] += 1
                    stats['win_types'][subcategory] += 1
                else:
                    stats['losses'] += 1
                    stats['loss_types'][subcategory] += 1
            elif result == "0-1":
                if color == 'black':
                    stats['wins'] += 1
                    stats['win_types'][subcategory] += 1
            ...
            for trait, count in traits.items():
                stats['personality_traits'][trait] += count
    ...
    def generate_summary_statistics(self) -> Dict:
        ...
        for game in self.games_data:
            categories[game['result_subcategory']] += 1
    ...
    def save_analysis_results(self):
        ...
        for engine, stats in self.engine_stats.items():
            ...
            enhanced_stats[engine] = {
                **stats,
                'win_types': dict(stats['win_types']),
                'loss_types': dict(stats['loss_types']),
                'personality_traits': dict(stats['personality_traits'])
            }
