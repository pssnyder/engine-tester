...
class UnifiedTournamentAnalyzer:
    ...
    def __init__(self, results_dir: str = RESULTS_DIR, output_dir: str = DASHBOARD_DATA_DIR):
    ...
    def generate_comprehensive_report(self) -> Dict[str, Any]:
        ...
        try:
            # Look for name consolidation in dashboard data directory first
            ...
            consolidation_summary = {
                ...
                "total_raw_names": sum(len(variants.get('variants', [])) if isinstance(variants, dict) else len(variants) for variants in consolidations.values()),
...
def main():
    ...
    output_file = os.path.join(analyzer.output_dir, "unified_tournament_analysis.json")
